...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/menukaonline/goindex-extended/js/DPlayer.min.js"></script>'
);
document.write(
